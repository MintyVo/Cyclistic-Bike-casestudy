...
Age and gender - This data can show the demographics of the existing customers which could be used to target others in similar groups

Marital status - This data can be used for promotional use to target entire families and not just individuals

Pricing of plans - This data can be used to optimize the cost benefit analysis for existing customers and potential new ones

Household data - This data could be used for targeting potential customers in certain income ranges and/or neighborhoods